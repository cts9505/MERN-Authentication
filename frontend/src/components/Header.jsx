...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-700'>
      ...
      <h1 className='flex items-center gap-2 justify-center sm:text-3x1 font-medium mb-2 text-transform: capitalize' style={{fontSize:"2rem"}} ref={textRef} >Hey {userData ? userData.name :'Developer'}!<img className="w-8 aspect-square" src={assets.hand_wave}/> </h1>
