                ...
                <td class="main-content">
                  <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                      ...
                      <tr>
                        <td style="padding: 0 0 10px; font-size: 14px; line-height: 150%;">
                          We received a account opening for this email: <span style="color: #4C83EE;">{{email}}</span>.
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 0 0 16px; font-size: 14px; line-height: 150%; font-weight: 700;">
                      ...
                      <tr>
                        <td style="padding: 0 0 24px;">
                          ...
                          <p class="button" >Verify Account</p>
                          </a>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 0 0 10px; font-size: 14px; line-height: 150%;">
                          If not done by you dont worry the account will be deleted if not verified soon.
                        </td>
                      </tr>
                    </tbody>
                  </table>
                ...
                <td class="main-content">
                  <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                      ...
                      <tr>
                        <td style="padding: 0 0 10px; font-size: 14px; line-height: 150%;">
                          You don't have to verify your account .
                          <br> Account verified!
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 0 0 10px; font-size: 14px; line-height: 150%;">
                          If not done by you dont worry the account will be deleted soon.
                        </td>
                      </tr>
                    </tbody>
                  </table>
